(function() {
	...
	test("mceTableSplitTableBeforeRow command with blank cells", function() {
		editor.setContent('<table><tbody><tr><td>1</td><td>2</td></tr><tr><td>&nbsp;</td><td>4</td></tr></tbody></table>');
		Utils.setSelection('tbody tr:nth-child(2)', 0);
		editor.execCommand('mceTableSplitTableBeforeRow');
		equal(cleanTableHtml(editor.getContent()), '<table><tbody><tr><td>1</td><td>2</td></tr></tbody></table><p>&nbsp;</p><table><tbody><tr><td>&nbsp;</td><td>4</td></tr></tbody></table>');
	});
